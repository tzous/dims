...
<title>站点修改</title>
 ...
 <script type="text/javascript" src="js/admin/typeedit.js"></script>
</head>
<body>
 ...
 <div class="editcontent"
  ...
  <div id="maindata" >
   ...
   <table class="table table-hover table-condensed">
    <tr>
     <th>设备类型ID：</th>
     <td><input id="typeid"  type="text" style="width:114px;"></input>
     </td>
    </tr>
    <tr>
     <th>设备类型名称：</th>
     <td><input id="typename" type="text"   style="width:114px;"></input>
     </td>
    </tr>
    <tr>
     <th>上级ID：</th>
     <td><input id="superid" type="text"   style="width:114px;"></input>
