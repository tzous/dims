...
<title>站点管理</title>
 ...
 <script type="text/javascript" src="js/admin/typesmgr.js"></script>
</head>
<body>
...
<!-- 对话框 -->
<div id="wedit" class="easyui-window" data-options="title:'设备类型管理',iconCls:'icon-save',modal:true,closed:true"
