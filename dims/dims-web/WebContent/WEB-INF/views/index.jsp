...
<header>
 ...
 <ul class="rt_nav">
  <li><a href="http://127.0.0.1：8080/dims" target="_blank" class="website_icon">站点首页</a></li>
  <li><a href="#" class="clear_icon">清除缓存</a></li>
  <li><a href="#" class="admin_icon">系统管理</a></li>
  <li><a href="#" class="set_icon">账号设置</a></li>
  <li><a href="login.do" class="quit_icon">logout</a></li>
 </ul>
</header>
<!--aside nav-->
<!--aside nav-->
<aside class="lt_aside_nav content mCustomScrollbar">
 <h2><a href="index.do">起始页</a></h2>
 <ul>
  <li>
   <dl>
    <dt>设备查询更新</dt>
    <!--class:active-->
    <dd><a href="product_list.html" class="active">查询</a></dd>
    <dd><a href="product_detail.html">常用布局示例</a></dd>
    <dd><a href="recycle_bin.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <dd><a href="order_list.html">常用布局示例</a></dd>
    <dd><a href="order_detail.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <dd><a href="user_list.html">常用布局示例</a></dd>
    <dd><a href="user_detail.html">常用布局示例</a></dd>
    <dd><a href="user_rank.html">常用布局示例</a></dd>
    <dd><a href="adjust_funding.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <dd><a href="setting.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <dd><a href="express_list.html">常用布局示例</a></dd>
    <dd><a href="pay_list.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    <dt>常用布局示例</dt>
    <dd><a href="discharge_statistic.html">常用布局示例</a></dd>
    <dd><a href="sales_volume.html">常用布局示例</a></dd>
   </dl>
  </li>
  <li>
   <p class="btm_infor">© DeathGhost.cn</p>
  </li>
 </ul>
</aside>
...
<script src="public/js/serial.js" type="text/javascript"></script>
<script src="public/js/pie.js" type="text/javascript"></script>
